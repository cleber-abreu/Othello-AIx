...
public class ReceberTituloActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recContas.setAdapter(new ChaveEvidenciaValorSimplesComTotalAdapter(this, getDadosDelegate(), getClickDelegate()));
    ...
    private ChaveValorTotal getDadosDelegate() {
        return new ChaveValorTotal() {
            ...
            public String labelDado(int position) {
                try {
                    return dados.getJSONArray("OBJ").getJSONObject(position).getString("CLIENTE");
                }catch (Exception e){
                    return "---";
                }
            }
    ...
    private ChaveEvidenciaValorSimplesComTotalAdapter.ClickDelegate getClickDelegate() {
        return new ChaveEvidenciaValorSimplesComTotalAdapter.ClickDelegate() {
            ...
            public void onClick(int position) {
                try{
                    Toast.makeText(ReceberTituloActivity.this, dados.getJSONArray("OBJ").getJSONObject(position).toString(), Toast.LENGTH_SHORT).show();
                }catch (Exception e){
                    Toast.makeText(ReceberTituloActivity.this, "ALGO ERRADO", Toast.LENGTH_SHORT).show();
                }
            }
        };
    }
