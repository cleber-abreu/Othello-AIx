...
public class ReceberCartaoAdapter extends RecyclerView.Adapter<ReceberCartaoAdapter.BaseHolder>{
    ...
    public ReceberCartaoAdapter(Context context, JSONObject pacoteDados){
    ...
    class ElementoHolder extends BaseHolder{
    ...
    class TotalHolder extends BaseHolder{
